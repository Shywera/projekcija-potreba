"""Backup SQLite baze - automatski (na svakom startu) + rucni (/backup download)."""
import shutil
...
ZADRZI = 20  # koliko zadnjih auto-backupa zadrzati
...
def auto_backup() -> None:
    """Kopiraj postojecu bazu u `backup/<naziv>_YYYYMMDD_HHMMSS.db`; zadrzi zadnjih ZADRZI."""
    p = db_putanja()
